...
for mouse in control_mice_list:
    ...
    for session in mouse:
        ...
        false_alarms = performance_dictionary["visual_false_alarms.npy"]
        correct_rejections = performance_dictionary["visual_correct_rejections"]
        vis_2_percentage_correct = (float(correct_rejections) / (correct_rejections + false_alarms)) * 100
        mouse_d_prime_list.append(vis_2_percentage_correct)
...
plt.title("Unrewarded Grating Performance")
