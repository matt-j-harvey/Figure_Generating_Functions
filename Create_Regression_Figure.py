...
def create_regression_figure(session_list, model_name, save_directory):
    ...
    pre_learning_vis_1, pre_learning_vis_2 = get_condition_average(pre_learning_sessions, model_name)
    intermediate_learning_vis_1, intermediate_learning_vis_2 = get_condition_average(intermediate_learning_sessions, model_name)
    post_learning_vis_1, post_learning_vis_2 = get_condition_average(post_learning_sessions, model_name)

    # Get Time Window
    print("Pre learning vis 1 shape", np.shape(pre_learning_vis_1))
