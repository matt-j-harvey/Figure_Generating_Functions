...
for mouse in control_mice_list:
    ...
    for session in mouse:
        ...
        trial_outcomes = performance_dictionary["visual_trial_outcome_list.npy"]
        print("trial Outcomes", trial_outcomes)
        number_of_trials = len(trial_outcomes)
        percentage_correct = np.divide(float(np.sum(trial_outcomes)), number_of_trials)
        mouse_d_prime_list.append(percentage_correct)
...
plt.savefig("/home/matthew/Pictures/Adil_Meeting_2022_06_14/percentage_correct.svg")
plt.show()
